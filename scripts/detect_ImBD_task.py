...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_dataset', type=str, default="./exp_main/data/xsum_gpt-4o_rewrite")
    parser.add_argument('--output_file', type=str, default="./exp_main/results/")
    parser.add_argument('--base_model', type=str, default="gemma-9b-instructs")
    parser.add_argument('--cache_dir', type=str, default="../cache")
    parser.add_argument('--train_dataset', type=str, default='./exp_main/data/squad_gpt-4o_rewrite')
