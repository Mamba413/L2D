...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_file', type=str, default="./exp_theory_fineGPT/results/squad_gpt2-xl")  # output file prefix
    parser.add_argument('--dataset', type=str, default="squad")
    parser.add_argument('--dataset_file', type=str, default="./exp_theory_fineGPT/data/squad_gpt2-xl")
